...
@Mod(MastersGuide.MODID)
public class MastersGuide
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "mastersguide";
    ...
    public MastersGuide(IEventBus modEventBus, ModContainer modContainer)
    {
